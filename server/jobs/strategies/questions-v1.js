...
const EN_LEADS = /^[\s"'¿]*(how|what|why|when|where|which|who|can|could|should|would|do|does|did|is|are|was|were|will|am)(?!\p{L})/iu

// Spanish question-word leads (with or without leading ¿)
const ES_LEADS = /^[\s"'¿]*(cómo|como|qué|que|por\s+qué|cuándo|cuando|dónde|donde|cuál|cual|quién|quien|puedo|puede|puedes|debería|deberia|hay)(?!\p{L})/iu
